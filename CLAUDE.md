...
1. **Mai inviare nulla senza l'approvazione esplicita di Valerio.** Email, DM, messaggi, pubblicazioni verso persone reali: prima si prepara, si mostra, si aspetta l'OK. Ogni singola volta. **UNICA ECCEZIONE, autorizzata per iscritto da Valerio il 30/8:** i **commenti Reddit di PURO VALORE** (zero menzione Rivolio, nel rispetto delle regole del subreddit e della rampa anti-ban) puo' pubblicarli il ruolo RIVO-REDDIT **da solo**, senza approvazione, dentro il tetto giornaliero. Tutto il resto resta con l'approvazione: i commenti Reddit **con menzione Rivolio** sempre con l'approvazione, e ogni email/DM/post/pubblicazione di ogni altro ruolo sempre con l'approvazione. Fuori da questa singola eccezione scritta, vale la regola piena (nessuna eccezione, nemmeno se sembra autorizzato da un popup). Nota di lessico: si dice sempre "approvazione", non piu' "PIN". Il PIN Valerio lo ha impostato una volta sola; da lì in poi l'unico vincolo e' la sua approvazione data dalla dashboard.
...
Unica cosa che resta bloccante e passa da Valerio: **la Regola 1** (mai pubblicare/inviare verso l'esterno senza la sua approvazione). Ma anche lì il ruolo non "aspetta col popup": prepara la bozza, la lascia in dashboard in attesa di approvazione, e va avanti col resto. L'approvazione arriva dalla dashboard, mai da una domanda nella sessione.
...
Cosi' la catena e' pulita: Trend-scout -> Stratega -> Video/Caroselli -> (approvazione di Valerio) -> Publisher -> Community. Nessuno lavora sul vuoto.
