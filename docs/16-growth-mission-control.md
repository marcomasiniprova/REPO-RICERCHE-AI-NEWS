...
## Stato
- 28/8: decise le fondamenta (Supabase realtime, Railway, home su squadra agenti). In attesa delle foto di stile di Valerio per partire con M1. Puliti i 3 residui di routine spenti; restano attive solo le 3 buone (SCOUT, IG e Email, REDDIT) nella sessione RIVO Operativo.
