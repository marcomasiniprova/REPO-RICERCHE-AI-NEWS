...
- PASSO 3: produci. Se articolo: scrivilo intero, ottimizzato, coi fatti veri, e consegnalo come bozza (draft_upsert con agent "seo", channel "seo", subject = titolo/keyword, body = articolo, status "bozza"). Se miglioria tecnica: mettila nel kv `seo_stato`.
